...
- A prior might be (roughly):
    1. **uninformative**: consistent with any result,
    2. **weakly informative**: consistent with many results,
    3. **strongly informative**: consistent with a small range of results.
...
- `brms` default priors **tend** towards uninformative.
...
- We're not allowing difference larger than about
